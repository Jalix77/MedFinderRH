...
describe('Phase 2C.3B — Encaissements clients', () => {
   ...
   * celle qu'utilisent tous les scenarios d'emission et d'encaissement de
   * cette suite.
   *
   ...
   *
   * Le scenario de periode FERMEE de ce fichier reste inchange : il
   * travaille sur un exercice lointain dedie (2036), sans collision
   * possible avec le mois courant.
   */
